    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, padding: '4rem' }}>
          ...
          {/* FOOTER BRANDING (Very subtle) */}
          <footer style={{ marginTop: 'auto', paddingTop: '4rem', textAlign: 'center', opacity: 0.3, fontSize: '0.7rem', color: '#94a3b8' }}>
             Generated by Mechatronian Hub Platform &bull; Professional Portfolio Builder
          </footer>
        </div>
      </div>
